...
export default function MessageScreen() {
  ...
  const handleSend = async (): Promise<void> => {
    ...
    setLocalMessages((prevMessages) => [newMessageObj, ...prevMessages]);
      ...
      setLocalMessages((prevMessages) => prevMessages.filter((msg) => msg.id !== newMessageObj.id));
    } finally {
      setIsSending(false);
    }
  };
  ...
  const renderMessage = ({ item }: { item: IMessage }) => (
    <View style={[styles.messageContainer, item.senderID === user.userID ? styles.userMessage : styles.otherMessage]}>
      <View style={item.senderID === user.userID ? styles.userAvatar : styles.otherAvatar} />
      <View style={[styles.messageBubble, item.senderID === user.userID ? styles.userBubble : styles.otherBubble]}>
